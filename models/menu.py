    ...
    wiki_dropdown = (
        ...
        [
            ...
            (
                T("Editing the wiki"),
                False,
                URL("wiki", "wiki", args=["editing-this-wiki"]),
                [],
            ),
        ],
    )
...
if auth.has_membership("admin"):
    marking_dropdown.extend(
        [
            ...
            (T("Marking Roles"), False, URL("marking", "marking_roles"), []),
            (
                T("Create Marking Assignment"),
                False,
                URL("marking", "new_assignment"),
                [],
            ),
            (
                T("Load Marking Assignments"),
                False,
                URL("marking", "load_assignments"),
                [],
            ),
            (T("View Marking Assignments"), False, URL("marking", "assignments"), []),
            (T("View Marker Progress"), False, URL("marking", "marker_progress"), []),
            (T("View Submitted Files"), False, URL("marking", "submitted_files"), []),
            (T("Marking Files"), False, URL("marking", "marking_files"), []),
        ]
    )


projects_dropdown = [
    (T("Overview"), False, URL("projects", "project_overview"), []),
    ...
    (T("Who are my markers?"), False, URL("marking", "who_are_my_markers"), []),
]
...
if auth.has_membership("admin"):
    projects_dropdown.extend(
        [
            ...
            (T("Project Admin"), False, URL("projects", "project_admin"), []),
...
if auth.has_membership("admin"):
    ...
    if n_new == 0:
        badge = SPAN(
            "0 new", _class="badge badge-pill badge-secondary", _style="margin:0px 5px"
        )
    else:
        badge = SPAN(
            str(n_new) + " new",
    ...
    response.menu.append(
        (
            ...
            [
                (T("Teaching Staff"), False, URL("manage", "teaching_staff"), []),
                (T("Courses"), False, URL("manage", "courses"), []),
                (
                    T("Coursework Presentations"),
                    False,
                    URL("manage", "presentations"),
                    [],
                ),
                (T("Students"), False, URL("manage", "students"), []),
                (
                    T("Student Coursework"),
                    False,
                    URL("manage", "student_presentations"),
                    [],
                ),
                (T("Upload Students"), False, URL("manage", "load_students"), []),
                (DIV(_class="dropdown-divider"), False, False, []),
                (CAT(T("View Users"), badge), False, URL("sm_admin", "show_users"), []),
                (T("View Email Log"), False, URL("sm_admin", "email_log"), []),
                (
                    T("Database (requires site password)"),
                    False,
...
if session.magic_auth is not None:
    ...
    response.menu.append(
        (
            ...
            [
                (
                    DIV(
                        f"Welcome {session.magic_auth.first_name}",
                        _class="dropdown-item",
                        _style="color:grey;font-variant:small-caps",
                    ),
                    False,
                ...
                (T("Home"), False, URL("staff", "home"), []),
                (T("My marking"), False, URL("marking", "my_marking"), []),
    ...
    response.menu.append(
        (
            ...
            [
                (
                    T("Proposing projects"),
                    False,
                    URL("staff", "proposing_projects"),
                    [],
                ),
                (T("Staff Login"), False, URL("staff", "staff_login"), []),
            ],
        )
    )
